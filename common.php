...
define("ADMIN_EMAIL", "admin@soloscoinwallet.com");
...
$rpc_user="Opera46";
$rpc_pass="8kh3qRSMF3GMqCXg";
$rpc_port="8652";

$coin_fullname = "Solos Coin"; //Website Title (Do Not include 'wallet')
$coin_short = "SLS"; //Coin Short 
$server_name = "http://soloscoinwallet.com";

$blockchain_url = $server_name.":3001/tx/"; //Blockchain Url
$support = "support@soloscoinwallet.com"; //Your support eMail
...
function sendpmail($smto, $smsub, $smbody)
{
	...
	$email_from ="noreply@soloscoinwallet.com";
	...
	$mail->Host = 'mail.operacoinwallet.com';  // Specify main and backup SMTP servers
	$mail->SMTPAuth = true;                               // Enable SMTP authentication
	$mail->Username = 'support@operacoinwallet.com';                 // SMTP username
	$mail->Password = '4IE{aHCqD_K$';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to

	$mail->setFrom('support@operacoinwallet.com', 'operaCoin');
	$mail->addAddress($smto);               // Name is optional
	$mail->addReplyTo('support@operacoinwallet.com', 'Support');
...
/*	
	...
	$mail->Host = 'mail.operacoinwallet.com';  // Specify main and backup SMTP servers
	$mail->SMTPAuth = true;                               // Enable SMTP authentication
	$mail->Username = 'donotreply@operacoinwallet.com';                 // SMTP username
	$mail->Password = '4IE{aHCqD_K$';                           // SMTP password
	$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
	$mail->Port = 587;                                    // TCP port to connect to
